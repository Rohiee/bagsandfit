<?php
/*
Plugin Name:    Juliette Package Demo Data
...
class Juliette_Data_Demo_Plugin_Class{
    ...
    public static $theme_name = 'juliette';

    public static $demo_site = 'https://juliette.novaworks.net/';
...
add_action('plugins_loaded', function(){
    ...
    if(strtolower($theme->get_template()) != 'juliette'){

        add_action( 'admin_notices', function(){
            printf( __( '%1$s"Juliette Package Demo Data" requires %3$s"Juliette"%4$s theme to be installed and activated. Please active %3$s"Juliette"%4$s to continue.%2$s', 'novaworks-demodata' ), '<div class="error"><p>', '</p></div>' ,'<strong>', '</strong>' );
        });
    ...
    Juliette_Data_Demo_Plugin_Class::get_instance();
}, 999);
